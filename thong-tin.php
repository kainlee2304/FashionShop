        ...
        <form style="margin-top: 30px">
        	<div class="col-md-6 container">
	            ...
	            <div class="form-group">
	                	<button class="col-md-4 container-fluid" style="margin-left: 162px;"><a href="sua-thong-tin.php" class="btn btn-info">chỉnh sửa</a></button>
	                <button class="col-md-4 container-fluid" >
